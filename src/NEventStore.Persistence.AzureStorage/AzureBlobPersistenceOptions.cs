...
namespace NEventStore.Persistence.AzureStorage
{
    ...
    public class AzureBlobPersistenceOptions
    {
            ...
            int blobNumPages = 2000)
        {
            ...
            if (!containerRegex.Match(containerName).Success)
            {
                throw new ArgumentException(
                    $"Container must start with lowercase letter, contain only lowercase letters and numbers, and have length between 3 and 63 characters. Failed container name was [{containerName}]");
            }
        ...
        /// </summary>
        public TimeSpan MaxTimeSpanForUndispatched { get; private set; }
        ...
        /// </remarks>
        public bool ForceUniqueCheckpoint { get; private set; }
        ...
        /// </remarks>
        public int ParallelConnectionLimit { get; set; }

        /// <summary>
        /// The number of pages a new blob will be created with.
        /// </summary>
        public int BlobNumPages { get; set; }
    }
}